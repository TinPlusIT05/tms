...
(function() {
	...
	LightboxOptions = (function() {
		...
		function LightboxOptions() {
			this.fileLoadingImage = '/trobz_base_web/static/lib/lightbox/images/loading.gif';
			this.fileCloseImage = '/trobz_base_web/static/lib/lightbox/images/close.png';
		...
		Lightbox.prototype.changeImage = function(imageNumber) {
			...
			preloader.onload = function() {
				...
				if (preloader.width > 800) {
					preloader.height = preloader.height / preloader.width * 800;
					preloader.width = 800;
					}
