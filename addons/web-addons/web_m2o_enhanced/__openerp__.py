...
- create: true/false -> disable "create" entry in dropdown panel + disable create button in search form 
...
""",
    ...
    "author": "Nicolas JEUDY <njeudy@tuxservices.com> && Trobz <http://trobz.com>",
    "installable" : True,
    "active" : False,
}
