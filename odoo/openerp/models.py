    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    def _read_from_database(self, field_names, inherited_field_names=[]):
        ...
        if missing:
            ...
            # Improve the error message about "Access Right"
            # in the user interface and in the log file
            exc = self.hook_nicer_error_message(missing.ids, self._description, 'read')
    ...
    def hook_nicer_error_message(self, cr, uid, ids, missing_ids, description,
                                 operation, context={}):
        return AccessError(
            _('The requested operation cannot be completed due to security '
    ...
    @api.cr_uid_ids_context
    def hook_improve_error_message_record_rules(self, cr, uid, ids,
                                                missing_ids,
                                                description, operation,
                                                context=None):
        """
        hook function to improve the message of record rule
        @return: Warning
        """
        return True
    ...
    def _check_record_rules_result_count(self, cr, uid, ids, result_ids, operation, context=None):
        ...
        if missing_ids:
            ...
            if forbidden_ids:
                ...
                if uid == SUPERUSER_ID:
                    return
                # the function help to improve message warning here
                self.hook_improve_error_message_record_rules(
                    cr, uid, ids, missing_ids, self._description,
