openerp.web.ListView.include({
    ...
    do_sticky_headers: function() {
        ...
        sticky_top_anchor.height(self.get_original_headers().height());
        if ($('.oe_list_sticky_top_anchor')) {
            sticky_headers_containers = $('.oe_list_sticky_top_anchor');
        ...
        $('.oe_list_sticky_top_anchor').show();
